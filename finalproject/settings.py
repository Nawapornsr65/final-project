...
HUGGINGFACE_API_URL = os.getenv(
    "HF_API_URL",
    f"https://api-inference.huggingface.co/models/{os.getenv('HF_MODEL_ID','biodatlab/whisper-th-medium-combined')}",
)
HF_TOKEN = os.getenv("HF_TOKEN")
HF_CHUNK_SECONDS = int(os.getenv("HF_CHUNK_SECONDS", "0"))
